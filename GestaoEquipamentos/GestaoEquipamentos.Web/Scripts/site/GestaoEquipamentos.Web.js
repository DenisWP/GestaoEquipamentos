...
(function (GestaoEquipamentos) {
    ...
    })(BasicSamples = GestaoEquipamentos.BasicSamples || (GestaoEquipamentos.BasicSamples = {}));
})(GestaoEquipamentos || (GestaoEquipamentos = {}));
var GestaoEquipamentos;
(function (GestaoEquipamentos) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = GestaoEquipamentos.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = GestaoEquipamentos.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = GestaoEquipamentos.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (GestaoEquipamentos) {
    ...
    })(Northwind = GestaoEquipamentos.Northwind || (GestaoEquipamentos.Northwind = {}));
})(GestaoEquipamentos || (GestaoEquipamentos = {}));
var GestaoEquipamentos;
(function (GestaoEquipamentos) {
    var Northwind;
...
(function (GestaoEquipamentos) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'GestaoEquipamentos.Northwind.Gender', 'GestaoEquipamentos.Northwind.Entities.Gender');
    })(Northwind = GestaoEquipamentos.Northwind || (GestaoEquipamentos.Northwind = {}));
})(GestaoEquipamentos || (GestaoEquipamentos = {}));
var GestaoEquipamentos;
(function (GestaoEquipamentos) {
...
(function (GestaoEquipamentos) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'GestaoEquipamentos.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = GestaoEquipamentos.Northwind || (GestaoEquipamentos.Northwind = {}));
})(GestaoEquipamentos || (GestaoEquipamentos = {}));
var GestaoEquipamentos;
(function (GestaoEquipamentos) {
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(GestaoEquipamentos.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(GestaoEquipamentos.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        GestaoEquipamentos.Common.ReportHelper.execute({
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: GestaoEquipamentos.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: GestaoEquipamentos.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new GestaoEquipamentos.Northwind.OrderDialog();
                        ...
                        var chai = GestaoEquipamentos.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = GestaoEquipamentos.Northwind.EmployeeRow.getLookup().items
        ...
        }(GestaoEquipamentos.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(GestaoEquipamentos.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.OrderDialog));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    GestaoEquipamentos.Northwind.CategoryService.Retrieve({
        ...
        }(GestaoEquipamentos.Northwind.CategoryDialog));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(GestaoEquipamentos.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new GestaoEquipamentos.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                GestaoEquipamentos.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(GestaoEquipamentos.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    GestaoEquipamentos.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(GestaoEquipamentos.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(GestaoEquipamentos.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    GestaoEquipamentos.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return GestaoEquipamentos.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return GestaoEquipamentos.LanguageList.getValue();
            };
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.SupplierDialog));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(GestaoEquipamentos.Northwind.SupplierGrid));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return GestaoEquipamentos.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return GestaoEquipamentos.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                GestaoEquipamentos.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    GestaoEquipamentos.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(GestaoEquipamentos.Northwind.CustomerDialog));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.CustomerGrid));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = GestaoEquipamentos.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(GestaoEquipamentos.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return GestaoEquipamentos.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new GestaoEquipamentos.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(GestaoEquipamentos.Northwind.OrderDetailDialog));
...
(function (GestaoEquipamentos) {
    ...
    (function (Northwind) {
        ...
        }(GestaoEquipamentos.Common.GridEditorBase));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Northwind.OrderDetailsEditor));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return GestaoEquipamentos.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return GestaoEquipamentos.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        ...
        }(GestaoEquipamentos.Common.BulkServiceAction));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return GestaoEquipamentos.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return GestaoEquipamentos.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(GestaoEquipamentos.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new GestaoEquipamentos.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new GestaoEquipamentos.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new GestaoEquipamentos.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (GestaoEquipamentos) {
    ...
    GestaoEquipamentos.SelectableEntityGrid = SelectableEntityGrid;
})(GestaoEquipamentos || (GestaoEquipamentos = {}));
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return GestaoEquipamentos.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return GestaoEquipamentos.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(GestaoEquipamentos.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = GestaoEquipamentos.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            GestaoEquipamentos.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return GestaoEquipamentos.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return GestaoEquipamentos.Northwind.ProductService.baseUrl; };
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return GestaoEquipamentos.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return GestaoEquipamentos.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return GestaoEquipamentos.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return GestaoEquipamentos.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (GestaoEquipamentos) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return GestaoEquipamentos.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return GestaoEquipamentos.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return GestaoEquipamentos.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: GestaoEquipamentos.Authorization.userDefinition.DisplayName,
